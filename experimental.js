// ==UserScript==
// @name         Think Collapse Chatbox v5.5
...
(function() {
    ...
    function processThinkTags(html, isLatest) {
        ...
        html = html.replace(encodedRegex, (match, openTag, content, closeTag) => {
            ...
            if (isLatest) {
                ...
                // Don't auto-expand: unsafeWindow.currentExpandedThinkId = id;
            }
            
            // All messages are collapsed by default now
            const displayStyle = "none";
            const buttonText = "Show Thinking Process";
    ...
    function processPartialThinkTags(html, isLatest) {
        ...
        // Also remove closing tag if present in streaming content
        ...
        // All content is collapsed by default now
        const displayStyle = "none";
        const buttonText = "Show Thinking Process";
        
        // For partial thinking, show a spinner indicator
        return `
